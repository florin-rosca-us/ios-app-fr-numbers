...
- (void)viewDidLoad {
    ...
    FRPageViewController *startingViewController = [self.modelController viewControllerAtIndex:0 storyboard:self.storyboard];
...
- (UIPageViewControllerSpineLocation)pageViewController:(UIPageViewController *)pageViewController spineLocationForInterfaceOrientation:(UIInterfaceOrientation)orientation {
    ...
    FRNumberViewController *currentViewController = self.pageViewController.viewControllers[0];
